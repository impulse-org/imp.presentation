...
/**
 *<b>
 *<li>Rule 34:  font_attribute_decl ::= FONT$ =$ resource_value ;$
 *</b>
 */
public class font_attribute_decl extends ASTNode implements Ifont_attribute_decl
{
    private Iresource_value _resource_value;

    public Iresource_value getresource_value() { return _resource_value; }

    public font_attribute_decl(IToken leftIToken, IToken rightIToken,
    ...
    public boolean equals(Object o)
    {
        ...
        //
        if (! (o instanceof font_attribute_decl)) return false;
        font_attribute_decl other = (font_attribute_decl) o;
