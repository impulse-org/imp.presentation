...
/**
 *<b>
 *<li>Rule 69:  editor_decl ::= EDITOR$ IDENTIFIER$id super_opt$sup editor_body$body
 *</b>
 */
public class editor_decl extends ASTNode implements Ieditor_decl
{
    private ASTNodeToken _id;
    private super_opt _sup;
    private editor_body _body;
    ...
    public editor_body getbody() { return _body; }

    public editor_decl(IToken leftIToken, IToken rightIToken,
                       ASTNodeToken _id,
                       super_opt _sup,
                       editor_body _body)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        //
        if (! (o instanceof editor_decl)) return false;
        editor_decl other = (editor_decl) o;
