...
public class PSPNature extends ProjectNatureBase {
    // SMS 28 Mar 2007: plugin class now totally parameterized
    public static final String k_natureID= PSPActivator.kPluginID + ".nature";
    ...
    public String getBuilderID() {
        return PSPBuilder.BUILDER_ID;
    }

    public void addToProject(IProject project) {
        super.addToProject(project);
        new SmapiProjectNature("psp").addToProject(project);
    };
